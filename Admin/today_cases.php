...
if(isset($_GET['delete']))
{
    ...
    echo "<script>alert('Case deleted successfully');window.location.href='today_cases';</script>";
}
?>
<!DOCTYPE html>
<!DOCTYPE html>
...
$stmt = $conn->prepare("SELECT * FROM cases WHERE calling_date='".date('Y-m-d')."' ORDER BY case_id DESC");
$stmt->execute();

...
if(isset($_GET['delete']))
{
    ...
    echo "<script>alert('Enquiry deleted successfully');window.location.href='view_enquiries';</script>";
}
?>
<!DOCTYPE html>
<html lang="en">
...
$stmt = $conn->prepare("SELECT * FROM enquiries ORDER BY id DESC");
$stmt->execute();
...
<td class="px-4 py-3"><?php echo $phone; ?></td>

<td class="px-4 py-3"><?php echo $service; ?></td>

<td class="px-4 py-3"><?php echo $message; ?></td>
